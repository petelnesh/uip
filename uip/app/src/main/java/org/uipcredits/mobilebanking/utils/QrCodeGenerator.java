...
import org.uipcredits.mobilebanking.models.templates.account.AccountType;
...
public class QrCodeGenerator {
     ...
     * @param accountType {@link  AccountType} i.e. SAVINGS or LOAN
    ...
    public static String getAccountDetailsInString(String accountNumber, String officeName,
                                                   org.uipcredits.mobilebanking.ui.enums. AccountType
                                                           accountType) {
        int accountId = -1;
        if (accountType ==  org.uipcredits.mobilebanking.ui.enums.AccountType.SAVINGS) {
            accountId = 0;
        } else if (accountType ==  org.uipcredits.mobilebanking.ui.enums.AccountType.LOAN) {
            accountId = 1;
        }
